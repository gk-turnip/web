...
<br/>
<ul>
<li>add copyright text to all javascript *DONE*</li>
<li>check if rain causes lag, put rain and avatar movement in same loop</li>
<li>refine movement of other player avatars *DONE*</li>
...
<li>There are still dandelions periodically showing up with black foliage instead of green. *DONE*</li>
<li>Avatars still sometimes switch to black and white in Chrome and Chromium. create a test that does much higher rate if switch in/out of the dandelion, change dandelion colouring to determine what is causing this. *DONE*</li>
<li>if you switch the avatar enough times, the game will stop responding *DONE*</li>
</ul></li>
